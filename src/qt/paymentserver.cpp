...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click diamond: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start diamond: click-to-pay handler");
    else
...
{
    // clicking on diamond: URLs creates FileOpen events on the Mac:
