...
// Copyright (c) 2013 Diamondcoin developers
...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/diamondcoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        {
            // First part of help message is specific to diamondcoind / RPC client
...
int main(int argc, char* argv[])
{
    ...
    // Connect diamondcoind signal handlers
    noui_connect();
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 8161 or testnet: 18161)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Diamondcoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Diamondcoin process is using the data directory.
