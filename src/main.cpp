...
// Copyright (c) 2013 The Diamondcoin developers
...
uint256 hashGenesisBlock("0x00000636e50163e5187eb74197c8205f527b7bde4949dab7f74933a1db900221");
...
const string strMessageMagic = "Diamondcoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    // Subsidy is cut in half every 40000 blocks (~13.8 days)
    nSubsidy >>= (nHeight / 40000);
    ...
    //1~1000            20*1000 = 20000 coins
    //1001+40000*1       50*40000 = 2000000
    //1001+40000*2       25*40000 = 1000000
    //1001+40000*3     12.5*40000 = 500000
    //1001+40000*4     6.26*40000 = 250000
    //here = 3770000 coins
    // so 20000000-3770000 = 12230000
    // 12230000 / 5 = 3246000 blocks
    // total blocks = 1000 + 40000 * 4 + 3246000 = 3407000
    if(nHeight>3407000) //total 1182.986 days  ~3.24 years
    {
        nSubsidy = 0;//No more coins create !!!
    }
...
//                           (pindex->nHeight==91880 && pindex->GetBlockHash() == uint256("0x00000000000743f190a18c5577a3c2d2a1f610ae9601ac046a38084ccb7cd721")));
    ...
    if (vtx[0].GetValueOut() > GetBlockValue(pindex->nHeight, nFees, pindex->nBits) && pindex->nHeight > 300)
...
*/
        ...
        // Genesis block
        const char* pszTimestamp = "2014-03-06 diamondcoin begin! Hello new world!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 112;
        block.nTime    = 1394111744;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 281469;

        if (fTestNet)
        {
            block.nTime    = 1394107016;
            block.nNonce   = 125121;
        }
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x00c5e27f30e3af86df6ddb95226a21397c9c2789332b4e7883ae6815ea45d75b"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DiamondcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DiamondcoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("DiamondcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("diamondcoin-miner");
    ...
    try { loop {
        ...
        printf("Running DiamondcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("DiamondcoinMiner terminated\n");
        throw;
    }
}
